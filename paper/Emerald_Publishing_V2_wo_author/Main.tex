...
\begin{document}
	...
	Fig.~\ref{fig:sota_acc} complements Table~\ref{tab:sota_compare} by reporting accuracy as a function of SNR.
	...
	On RadioML2016.10A, the accuracy curve of IQFormerLite closely tracks IQFormer, with a small gap in the high-SNR plateau, which suggests that most discriminative capacity is retained under compression.
	On RadioML2016.10B, the high-SNR region shows near overlap between IQFormerLite and IQFormer, which is consistent with the larger training scale of RadioML2016.10B and suggests that a compact model can match a larger counterpart when sufficient data are available.
	
	\begin{figure}[htbp]
		\centering
		\subfloat[\centering]{\includegraphics[width=0.49\linewidth]{Figures/RML201610a_sota_acc.png}\label{fig:sota_acc_a}}
		\hfill
		\subfloat[\centering]{\includegraphics[width=0.49\linewidth]{Figures/RML201610b_sota_acc.png}\label{fig:sota_acc_b}}
		\caption{Comparison of recognition accuracy under varying SNR levels. (a) Accuracy trend on RadioML2016.10A. (b) Accuracy trend on RadioML2016.10B. \label{fig:sota_acc}}
	\end{figure}
	...
	Fig.~\ref{fig:mod_acc_comparison}(a)--(d) reports per-class accuracies of IQFormer and IQFormerLite on RadioML2016.10A and RadioML2016.10B.
	A consistent pattern appears among closely confusable analog modulations: IQFormerLite improves recognition of WBFM relative to IQFormer, but this local gain is paired with lower accuracy on AM-DSB.
	...
	\begin{figure}[htbp]
		\centering
		\subfloat[\centering]{\includegraphics[width=0.49\linewidth]{Figures/RML201610a_IQFormer_mod_acc.png}\label{fig:mod_acc_a}}
		\hfill
		\subfloat[\centering]{\includegraphics[width=0.49\linewidth]{Figures/RML201610a_IQFormerLite_mod_acc.png}\label{fig:mod_acc_b}}
		
		\vspace{6pt}
		
		\subfloat[\centering]{\includegraphics[width=0.49\linewidth]{Figures/RML201610b_IQFormer_mod_acc.png}\label{fig:mod_acc_c}}
		\hfill
		\subfloat[\centering]{\includegraphics[width=0.49\linewidth]{Figures/RML201610b_IQFormerLite_mod_acc.png}\label{fig:mod_acc_d}}
		
		\caption{Comparison of per-modulation recognition accuracy between the baseline IQFormer and the proposed IQFormerLite.
